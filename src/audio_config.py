...
AUDIO_SETTINGS = {
    ...
    "click_sound": "/static/audio/click.ogg",
    "intro_music": {
        "id": "trilha-sonora-intro",
        "src": "/static/audio/Game_1999.ogg",
        "volume": 0.3,
        "loop": True
    },
    "game_music_1999": {
    ...
    "game_music_2026": {
        ...
        "src": "/static/audio/Game_2026.ogg",
        "volume": 0.25,
        "loop": True
    },
    "countdown_bip_normal": "/static/audio/bip_normal.ogg",
    "countdown_bip_final": "/static/audio/bip_final.ogg",
}
